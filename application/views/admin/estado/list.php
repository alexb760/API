        ...
        <div class="span12 columns">
          <div class="well">
           ...
           $options_products = array();    
            ...
            echo form_open('adminapp/admin_estado', $attributes);
            ...
            <tbody>
              ...
              foreach($products as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("index.php/adminapp").'/'.$this->uri->segment(2).'/update/'.$row['id'].'" class="btn btn-info">view & edit</a>  
                  <a href="'.site_url("index.php/adminapp").'/products/delete/'.$row['id'].'" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
