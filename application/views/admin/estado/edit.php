<div class="container top">
      ...
      echo form_open('index.php/adminapp/admin_estado/add'.$this->uri->segment(4).'', $attributes);
      ?>
        <fieldset>
          <div class="control-group">
            <label for="inputError" class="control-label">Descripcion</label>
            <div class="controls">
              <input type="text" id="decripcion" name="descripcion" value="<?php echo $product[0]['descripcion']; ?>" 
