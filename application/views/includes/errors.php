...
<head>
  ...
  <title>Opps! Algo paso  404</title>
...
<body class="login">
  <div class="error_page">
    <img alt="Kidmondo_face_sad" src="<?php echo base_url(); ?>assets/imagenes/kidmondo_face_sad.gif" />
    <h1><?php echo $nombre_error; ?></h1>
    <p><?php echo $descripcion; ?></p>
    <p><a href="<?php echo base_url(); ?>">Regresar A la página principal.</a></p>
  </div>
</body>
</html>